        ...
        <div class="issue-detail-page_content">
          <div class="issue-detail-page_container">
            ...
            <div class="issue-detail-page_section">
              ...
              <p class="issue-detail-page_placeholder">
            ...
            <div class="issue-detail-page_metadata">
              ...
              @if (issue()?.due_date) {
                <div class="issue-detail-page_metadata-item">
                  ...
                  <span class="issue-detail-page_metadata-value">{{ formatDate(issue()!.due_date!) }}</span>
                </div>
              }
              @if (issue()?.story_points) {
                <div class="issue-detail-page_metadata-item">
                  <span class="issue-detail-page_metadata-label">Story Points</span>
                  <span class="issue-detail-page_metadata-value">{{ issue()!.story_points }}</span>
                </div>
              }
              <div class="issue-detail-page_metadata-item">
                <span class="issue-detail-page_metadata-label">Created</span>
                <span class="issue-detail-page_metadata-value">{{ formatDate(issue()!.created_at) }}</span>
              </div>
              <div class="issue-detail-page_metadata-item">
                <span class="issue-detail-page_metadata-label">Updated</span>
                <span class="issue-detail-page_metadata-value">{{ formatDate(issue()!.updated_at) }}</span>
              </div>
            </div>
          </div>
          </div>
